...
import { ButtonPrimary, Box, Flex, Text, H3, H2 } from '..';
    ...
    <Box backgroundColor="levels.deep">
      ...
      {popovers.map(({ anchorOrigin, transformOrigin, name }) => (
        <Popover
          ...
          // Note: this is necessary, because rendering many popovers at once
          // causes a "loop of death" with popovers fighting one another for
          // focus until they blow up the stack.
          disableEnforceFocus
        >
